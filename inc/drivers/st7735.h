...
#define __ST7735_H__
  ...
  //-------------- Port Data Control -----------------------
  #ifndef ST7735_PORT_DC_LD
    #define ST7735_PORT_DC_LD  PORTA
  #endif
  #ifndef ST7735_DDR_DC_LD
	  #define ST7735_DDR_DC_LD  DDRA
  #endif
  #ifndef ST7735_DC_LD
    #define ST7735_DC_LD  PA2
  #endif  
  //-------------- Port Backligth -----------------------
  #ifndef ST7735_PORT_BL
	#define ST7735_PORT_BL	PORTA
  #endif
  #ifndef ST7735_DDR_BL
    #define ST7735_DDR_BL	DDRA
    #endif
  #ifndef ST7735_BL
    #define ST7735_BL		PA0
  #endif
  //-------------- Port Chip Select -----------------------
  #ifndef ST7735_PORT_CS_LD
    #define ST7735_PORT_CS_LD  PORTA
  #endif
  #ifndef ST7735_DDR_CS_LD
    #define ST7735_DDR_CS_LD  DDRA
  #endif
  #ifndef ST7735_CS_LD
    #define ST7735_CS_LD  PA1
  #endif
  
  
  #ifndef ST7735_MOSI
    #define ST7735_MOSI   PD1
  #endif 
  #ifndef ST7735_SCK
    #define ST7735_SCK    PD0
  #endif

  #ifndef HW_RESET_DDR
    #define HW_RESET_DDR  DDRA
  #endif
  #ifndef HW_RESET_PORT
    #define HW_RESET_PORT PORTA
  #endif
  #ifndef HW_RESET_PIN
    #define HW_RESET_PIN  PA3
  #endif
